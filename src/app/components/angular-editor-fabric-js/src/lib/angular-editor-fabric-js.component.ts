...
export class FabricjsEditorComponent implements AfterViewInit {
  ...
  // canvas-container
  public size: any = {
    width: (window.innerWidth > 0) ? window.innerWidth : screen.width < 590 ? (window.innerWidth > 0) ? window.innerWidth : screen.width : 590,
    height:(window.innerWidth > 0) ? window.innerWidth : screen.width < 590 ? (window.innerWidth > 0) ? window.innerWidth : screen.width : 590,
  };
  ...
  ngAfterViewInit(): void {
    ...
    this.canvas.on({
      ...
      'object:selected': (e) => {
        ...
        selectedObject.cornerColor = 'rgba(33,150,243,0.7)';
  ...
  addFigure(figure) {
    ...
    switch (figure) {
      case 'rectangle':
        add = new fabric.Rect({
          width: 120, height: 35, left: 100, top: 100, angle: 0,
          fill: '#3f51b5'
        });
        break;
    }
  ...
  setCanvasFill() {
    if (!this.props.canvasImage) {
      this.canvas.backgroundImage = this.props.canvasFill;
